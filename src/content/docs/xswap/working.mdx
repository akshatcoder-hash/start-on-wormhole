...
{/* \( \text{Interest Rate} = \frac{\text{Total Borrowed Amount}}{\text{Total Deposited Amount}} \)
\( \text{Interest Rate} = \frac{\text{Total Deposited Amount}}{\text{Total Borrowed Amount}} \) */}
...
Liquidation Penalty=Borrowed Amount×Liquidation RateLiquidation Penalty=Borrowed Amount×Liquidation Rate

Remaining Collateral=Initial Collateral−Liquidation PenaltyRemaining Collateral=Initial Collateral−Liquidation Penalty
